...
class GoGenerator(BaseGenerator):
    ...
    def generate_enum(self, enum_definition: EnumDefinition):
        ...
        enum_file_path = self._base_path + "/roc/" + go_name + ".go"
        ...
        if go_type_name in _GO_COMMENT_OVERRIDE:
            ...
            enum_file.write(self._format_comment(enum_definition.doc, ""))

        roc_prefix = self._api_root.name_prefixes[enum_definition.name]
    ...
    def generate_struct(self, struct_definition: StructDefinition):
        ...
        struct_file_path = self._base_path + "/roc/" + go_name + ".go"
        ...
        if go_type_name in _GO_COMMENT_OVERRIDE:
            ...
            struct_file.write(self._format_comment(struct_definition.doc, ""))
    ...
    def generate_class(self, class_definition: ClassDefinition):
        ...
        class_file_path = self._base_path + "/roc/" + go_name + "_DUMMY.go"
        ...
        class_file.write(self._format_comment(class_definition.doc, ""))
        class_file.write("//\n")
    ...
    def _doc_item_to_string(self, doc_item: list[DocItem]):
        ...
        for item in doc_item:
            ...
            if t == "text" or t == "bold" or t == "emphasis":
                ...
                result.append(self._ref_to_string(item.text))
            elif t == "see":
                result.append('See')
            elif t == "list":
                ul = "\n"
